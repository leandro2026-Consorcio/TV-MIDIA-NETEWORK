...
import { Tv, Lock, Mail, Loader2, AlertCircle } from 'lucide-react';
    ...
    <div className="min-h-screen bg-slate-950 flex flex-col justify-center items-center px-4 py-12">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-xl font-semibold text-slate-200">Acesse sua conta SaaS</h1>
          <p className="text-slate-400 text-sm mt-1">Gerencie suas telas, mídias e saldo de créditos</p>
        </div>
