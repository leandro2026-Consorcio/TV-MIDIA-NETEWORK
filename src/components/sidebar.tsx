  ...
  const companyGroups: NavGroup[] = useMemo(() => [
    {
      ...
      items: [
        ...
        { name: 'Automações Multicanal', href: '/multichannel-automations', icon: RadioTower },
        { name: 'Creators & Indicações', href: '/referrals', icon: Handshake },
  ...
  const creatorGroups: NavGroup[] = useMemo(() => [
    {
      ...
      items: [
        ...
        { name: 'Automações Multicanal', href: '/multichannel-automations', icon: RadioTower },
        { name: 'Minhas Indicações', href: '/referrals', icon: Share2 },
